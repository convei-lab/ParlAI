...
--outfile ./data/pbst/machine_generated_5beasm.txt \
--task pbst --seed_messages_from_task 1 \
--model-file zoo:dodecadialogue/convai2_ft/model \
--skip-generation False --inference nucleus --beam-size 5 --beam-min-length 10 --beam-block-ngram 3 --beam-context-block-ngram 3 \
--save-format parlai
